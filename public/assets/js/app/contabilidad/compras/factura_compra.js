$(document).ready(function () {
    ...
    $("#new_row_edit").click(function () {
        ...
        if (descuento_porcentaje_edit == 0) {
            descuento = '<input type="text" value="0.00" placeholder="Descuento" class="form-control text-end descuento_edit input_dinner" style="border: 0">';
        } else {
            descuento = '<input type="number" value="0" min="0" max="100" placeholder="Descuento" class="form-control text-end descuento_edit" style="border: 0">';
        }
    ...
    $(document).on("change", ".tipo_edit", function () {
        ...
        if (value == 1) {
            ...
            $(this).parent().parent().find(".producto_edit").append(
                productos.map((item) => {
                    return (
                        '<option value="' +
                        item.id +
            ...
            $(this).parent().parent().find(".serial_producto_edit").attr("disabled", false);
        } else {
            $(this).parent().parent().find(".producto_edit").empty();
            $(this).parent().parent().find(".producto_edit").append(
                cuentas_gastos.map((item) => {
            ...
            $(this).parent().parent().find(".serial_producto_edit").attr("disabled", true);
        }
    });
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.info == 1) {
                    ...
                    $("#centro_costo_edit").val(data.centro_costo).trigger("change");
                    ...
                    $("#factura2_proveedor_edit").val(data.num_factura_proveedor);
                    ...
                    productos.forEach(producto => {
                        if (contador == 0) {
                            $(".tipo_edit").val(producto.tipo).trigger("change");
                            setTimeout(() => {
                                if (producto.tipo == 1) {
                                    $(".producto_edit").val(producto.producto).trigger("change");
                                } else {
                                    $(".producto_edit").val(producto.cuenta).trigger("change");
                                }
                            }, 1000);
        ...
        facturas.forEach(function (factura) {
            if (factura.Quantity && factura.Quantity > 0) {
                ...
                var settings = {
                    ...
                    "timeout": 0,
                    "headers": {
                        "Authorization": "Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6IkYyRDQ2NTgyMUY1QjE2QTU3QkZENDQ3NUVBNzgwRTk1MzlGMTFEOThSUzI1NiIsInR5cCI6ImF0K2p3dCIsIng1dCI6Ijh0UmxnaDliRnFWN19VUjE2bmdPbFRueEhaZyJ9..Wj9InDNw034GtnQSrPDq8njQZr8FxwbOMm3hyk7zbjCFXsWiL0NLAlhnXRgheQ_e4h5nvML_h4RI59dImIEVirP_c-PVnkN7_RvxS61Y6qGbovkAGJulAm8vKrSW5n71WCimaFtADYzTPk-gLf5Kr_XUKyr3IaqtSNrTOudXJ2nQLF1y01Us_Ei7WuxR_QgmbdRI-KN62-CA2vbdLabSVi5qthjhXA9WBIBBYB9e36UD70jYSR4lqpnD5oaovKpMrKklfXO3nF6cMStgvfEj-basl6fcoc-g0u9TLW6zcCKx56zhymxrSv0e6yUu6DZF9MOKqAvjtSU5c1vxN_WzXw"
                    },
                };
