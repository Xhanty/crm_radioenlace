$(document).ready(function () {
    ...
    $("#btnAddPago").click(function () {
        ...
        if (tipo == "") {
            ...
            toastr.error("Seleccione un centro de costo");
            return false;
        } else if (forma_pago == "") {
            ...
            formData.append("pagado", pagado.toLocaleString('de-DE', { minimumFractionDigits: 2, maximumFractionDigits: 2 }));
                ...
                success: function (response) {
                    if (response.info == 1) {
                        if (terminado == 1) {
                            ...
                            window.location.href = url_general + "factura_compra";
                        } else {
                            toastr.success("Pago guardado correctamente");
                            setTimeout(function () {
                                location.reload();
