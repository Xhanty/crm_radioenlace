                                        ...
                                        <td align="center"
                                            ...
                                            @if ($valid_transaction == 1)
                                                <div
                                                    ...
                                                    Solicitud de Inventario Creada
                                                </div>
                                            @else
                                                <div
                                                    style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:38px;font-weight:bold;line-height:1;text-align:center;color:#555;">
                                                    Solictud de Inventario Gestionada
                                                </div>
                                            @endif
                                        </td>
                                    </tr>
                                        ...
                                        <td align="center"
                                            ...
                                            @if ($valid_transaction == 1)
                                                <div
                                                    ...
                                                    Hola. Hay una nueva solicitud de inventario con el token
                                            ...
                                            @else
                                                <div
                                                    style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:18px;line-height:1;text-align:center;color:#555;">
                                                    Hola. Se ha gestionado la solicitud de inventario con el token
                                                    <b>{{ $solicitud->codigo }}</b>. Por el usuario
                                                    <b>{{ $user->name }}</b>.
                                                </div>
                                            @endif
                                                    ...
                                                    <td align="center" bgcolor="#DA251D" role="presentation"
                                                        ...
                                                        <a href="https://crm.formrad.com/home" target="_blank"
                                                            ...
                                                            <p
                                                                ...
                                                                Solicitud de inventario: {{ $solicitud->codigo }}
                                                            </p>
                                                        </a>
                                                    </td>
                                                </tr>
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                ...
                                                Para ver los detalles de la solicitud de inventario, recuerda que debes ingresar a la
                                                plataforma.
                                            </div>
                                        </td>
                                    </tr>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td align="center"
                                                            ...
                                                            <div
                                                                style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:12px;font-weight:300;line-height:1;text-align:center;color:#575757;">
                                                                <a href="" style="color:#575757">Radio Enlace
                                                                    S.A.S</a>
                                                            </div>
                                                        </td>
                                                    </tr>
