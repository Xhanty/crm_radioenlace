...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('emails/css/app.min.css') }}">
    <link rel="stylesheet" href="{{ asset('emails/css/style.css') }}">
</head>
                ...
                <div class="as-invoice invoice_style1">
                    <div class="download-inner" id="download_section">
                        <header class="as-header header-layout1">
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto">
                                    <div class="header-logo" style="width: 70px; height: 70px;"><a href="#"><img
                                                src="{{ asset('assets/img/brand/logo.png') }}" alt="Invce"></a>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <h1 class="big-title">Cotización</h1>
                                </div>
                            </div>
                            <div class="header-bottom">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <div class="border-line"><img src="{{ asset('emails/img/line_pattern.svg') }}"
                                                alt="line">
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        <p class="invoice-number me-4"><b>Cotización No: </b>#155</p>
                                    </div>
                                    <div class="col-auto">
                                        <p class="invoice-date"><b>Fecha: </b>27/01/2023</p>
                                    </div>
                                </div>
                            </div>
                        </header>
                        <div class="row justify-content-between mb-4">
                            <div class="col-auto">
                                <div class="invoice-left"><b>Cliente:</b>
                                    <address>Seracis LTDA<br>811007280-1<br>Medellín, Colombia</address>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="invoice-right"><b></b>
                                    <address>Radio Enlace S.A.S<br>830504313-5<br>Medellín, Colombia</address>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-between">
                            <div class="col-auto">
                                <div class="invoice-left"><b>Descripción</b>
                                    <p class="mb-0">Desinstalación de los equipos en Girardota pertenecientes <br>a
                                        Conconcreto para ser instalados en el centro Comercial <br>Sao Paulo</p>
                                </div>
                            </div>
                            <div class="col-auto">
                        ...
                        <p class="invoice-note mt-3"><svg width="13" height="16" viewBox="0 0 13 16"
                                ...
                                <path
                                    ...
                                    fill="#1CB9C8"></path>
                            </svg> <b>NOTA:</b>Labor realizada por coordinador de altura y dos técnicos.</p>
                    ...
                    <div class="invoice-buttons"><button class="print_btn"><svg width="16" height="16"
                                ...
                                <path
                                    ...
                                    fill="white"></path>
                            </svg> <span>Imprimir</span></button> <button id="download_btn" class="download_btn"><svg
                                ...
                                <path
                                    ...
                                    fill="white"></path>
                            </svg> <span>Descargar</span></button></div>
                </div>
            </main>
        </div>
    </div>
    <script src="{{ asset('emails/js/jquery-3.6.0.min.js') }}"></script>
    <script src="{{ asset('emails/js/app.min.js') }}"></script>
    <script src="{{ asset('emails/js/main.js') }}"></script>
</body>
