<div id="contabilidad_div" class="col-lg-8 col-xl-10 div-list-ocult">
    <div class="col-12">
        <div class="card custom-card">
            <div class="card-header d-flex" style="border-bottom: 1px #e7e7e7 solid; margin-bottom: 8px">
                <div class="col-6" style="padding: 0px;">
                    <div class="card-title" style="margin-bottom: 0px">Contabilidad</div>
                </div>
                <div class="col-6" style="padding: 0px;">
            ...
            <div class="row" style="width: 99%; margin-left: 6px">
                ...
                <div class="col-lg-6 col-xl-3 col-md-12 col-sm-12 p-2">
                    <div class="card">
                                ...
                                <div class="col-lg-12">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <p class="tx-13 text-muted mb-0">Gestionar Vistos Bueno</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-footer p-3">
                            <label class="form-switch float-end mb-0">
                                <input type="checkbox" value="contabilidad_visto_bueno" class="form-switch-input check-con-9">
                                <span class="form-switch-indicator custom-radius"></span>
                            </label>
                        </div>
                    </div>
