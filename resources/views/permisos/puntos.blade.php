            ...
            <div class="row" style="width: 99%; margin-left: 6px">
                <div class="col-lg-6 col-xl-4 col-md-12 col-sm-12 p-2">
                    <div class="card">
                        ...
                        <div class="card-footer p-3">
                            <label class="form-switch float-end mb-0">
                                <input checked disabled value="ver_puntos" type="checkbox" class="form-switch-input">
                                <span class="form-switch-indicator custom-radius"></span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-xl-4 col-md-12 col-sm-12 p-2">
                    <div class="card">
                        ...
                        <div class="card-footer p-3">
                            <label class="form-switch float-end mb-0">
                                <input type="checkbox" value="gestionar_puntos" class="form-switch-input check-punt-1">
                                <span class="form-switch-indicator custom-radius"></span>
                            </label>
                        </div>
                    </div>
