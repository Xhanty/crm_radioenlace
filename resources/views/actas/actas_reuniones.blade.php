...
@section('content')
    <div class="main-container container-fluid">
        ...
        <!-- Edit -->
        <div class="row row-sm d-none" id="div_edit_acta">
            <div class="col-md-12 col-xl-12">
                <div class=" main-content-body-invoice">
                    <div class="card card-invoice">
                        <div class="card-header ps-3 pe-3 pt-3 pb-0 d-flex-header-table">
                            <div class="div-1-tables-header">
                                <h3 class="card-title">Modificar acta</h3>
                            </div>
                            <div class="div-2-tables-header" style="margin-bottom: 13px">
                                <button class="btn btn-primary back_home_edit">x</button>
                            </div>
                        </div>
                        <div class="p-0">
                            <div class="card-body" style="margin-top: -18px;">
                                ...
                                <div class="row row-sm">
                                    ...
                                    <div class="col-lg-4">
                                        <label for="">Hora Inicio</label>
                                        <input class="form-control" id="hora_ini_edit" placeholder="Hora Inicio"
                                            type="time">
                                    </div>
                                    <div class="col-lg-4">
                                        <label for="">Hora Fin</label>
                                ...
                                <div class="row row-sm">
                                    <div class="col-lg-4">
                                        <label for="">Area</label>
                                        <select class="form-select" id="area_edit">
                                            <option value="">Seleccione una opción</option>
                                            <option value="1">Administración</option>
                                            <option value="2">Comercial</option>
                                            <option value="3">Contabilidad</option>
                                    ...
                                    <div class="col-lg-4">
                                        <label for="">Asistentes</label>
                                        <select class="form-select" id="asistentes_edit" multiple>
                                            <option value="">Seleccione una opción</option>
                                            @foreach ($usuarios as $key => $item)
                                                <option value="{{ $item->id }}">{{ $item->nombre }}</option>
                                            @endforeach
                                ...
                                <div class="row row-sm">
                                    ...
                                    <div class="col-lg mt-4">
                                        <label for="">Adjunto</label>
                                        <input class="form-control" accept="application/pdf" id="adjunto_edit"
                                            placeholder="Contacto" type="file">
                                    </div>
                                </div>
                                <div class="text-center mt-5">
                                    <button class="btn btn-primary" id="btnEditActa">Modificar Acta</button>
                                </div>
                            </div>
                        </div>
                    </div>
