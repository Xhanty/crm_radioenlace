                            ...
                            <div class="d-flex">
                                <div class="my-auto">
                                    <svg enable-background="new 0 0 477.849 477.849"
                                        class="me-4 ht-60 wd-60 my-auto warning" version="1.1" viewBox="0 0 477.85 477.85"
                                ...
                                <div class="project-content">
                                    <h6>Asignaciones Generales</h6>
                                    <ul>
                                        <li>
                                            <strong>Pendientes</strong>
                                            <span>{{ $asignaciones_g_pendientes }}</span>
                                        </li>

                                        <li>
                                            <strong>Completadas</strong>
                                            <span>{{ $asignaciones_g_completadas }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="card overflow-hidden project-card">
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <div class="project-content">
                                    <h6>Asignaciones Proyectos</h6>
                                    <ul>
                                        <li>
                                            <strong>Pendientes</strong>
                                            <span>{{ $asignaciones_p_pendientes }}</span>
                                        </li>

                                        <li>
                                            <strong>Completadas</strong>
                                            <span>{{ $asignaciones_p_completadas }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="d-flex">
                                <div class="my-auto">
                                    <svg enable-background="new 0 0 438.891 438.891"
                                        class="me-4 ht-60 wd-60 my-auto primary" version="1.1" viewBox="0 0 438.89 438.89"
                                        xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="d-flex">
                                <div class="my-auto">
                                    <svg enable-background="new 0 0 469.682 469.682" version="1.1"
                                        class="me-4 ht-60 wd-60 my-auto success" viewBox="0 0 469.68 469.68"
                                        xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
                                        <path
            ...
            <div class="row row-sm ">
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body pb-3">
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-10">Últimas Asignaciones Generales</h4>
                                <i class="mdi mdi-dots-horizontal text-gray"></i>
                            </div>
                            <p class="tx-12 text-muted mb-3">Aquí aparecerán las últimas 5 asignaciones pendientes. <a
                                    href="{{ route('asignaciones_clientes') }}">Ver todas</a></p>
                            <div class="table-responsive mb-0 projects-stat tx-14">
                                <table
                                    ...
                                    <tbody>
                                        @foreach ($asignaciones_generales as $item)
                                            <tr>
                                                <td>
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
                    <div class="card overflow-hidden">
                        <div class="card-body pb-3">
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-10">Últimas Asignaciones De Proyectos</h4>
                                <i class="mdi mdi-dots-horizontal text-gray"></i>
                            </div>
                            <p class="tx-12 text-muted mb-3">Aquí aparecerán las últimas 5 asignaciones pendientes. <a
                            ...
                            <div class="table-responsive mb-0 projects-stat tx-14">
                                <table
                                    ...
                                    <tbody>
                                        @foreach ($asignaciones_proyectos as $item)
                                            <tr>
                                                <td>
                                                    <div class="project-names">
                                                        <p class="d-inline-block font-weight-semibold mb-0">
