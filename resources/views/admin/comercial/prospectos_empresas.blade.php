                ...
                <div class="card">
                    <div class="card-header d-flex-header-table" style="border-radius: 4px">
                        ...
                        <div class="div-2-tables-header">
                            <a title="Exportar" class="btn btn-warning" href="{{ route('prospectos_empresas_bd_excel') }}" target="_blank">
                ...
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="text-center">
                            <a href="{{ route('prospectos_empresas_bd_plantilla') }}" target="_blank">Descargar plantilla</a>
                        </div>
                    </div>
                    <div class="modal-footer">
