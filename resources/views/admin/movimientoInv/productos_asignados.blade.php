            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> Productos Asignados</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header d-flex-header-table bg-warning" style="border-radius: 4px">
                        <div class="div-1-tables-header">
                            <h3 class="card-title mt-2">Productos Asignados</h3>
                        </div>
                    </div>
                    <div class="card-body">
...
@section('scripts')
    <script src="{{ asset('assets/js/app/movimiento_inv/productos_asignados.js') }}"></script>
@endsection