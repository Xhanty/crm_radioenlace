            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> Gestionar Causaciones</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header d-flex-header-table bg-warning" style="border-radius: 4px">
                        <div class="div-1-tables-header">
                            <h3 class="card-title mt-2">Lista de Causaciones</h3>
                            <div class="row row-sm">
                                <div class="col-lg">
                        ...
                        <div class="div-2-tables-header">
                            <button class="btn btn-primary" data-bs-target="#modalAdd" data-bs-toggle="modal"
                                data-bs-effect="effect-scale">Crear Causación</button>
                        </div>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex-header-table bg-success" style="border-radius: 4px">
                        <div class="div-1-tables-header">
                            <h3 class="card-title mt-2">Lista de Causaciones Completadas</h3>
                            <div class="row row-sm">
                                <div class="col-lg">
                                    <label for="">Rango de fecha</label>
...
@section('scripts')
    <script src="{{ asset('assets/js/app/contabilidad/causaciones.js') }}"></script>
@endsection
