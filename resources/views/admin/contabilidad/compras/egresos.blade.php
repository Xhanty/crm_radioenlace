                                ...
                                @foreach ($comprobantes as $key => $comprobante)
                                    <div class="media comprobante_btn" data-id="{{ $comprobante->id }}">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <h6><span>RP No.{{ $comprobante->numero }}</span>
                                                <span>{{ $comprobante->valor }}</span>
                                            </h6>
                                            <div>
                                                <p><span>Fecha:</span>
                                                    {{ date('d/m/Y', strtotime($comprobante->created_at)) }}</p>
                        ...
                        <div class="card-body">
                            ...
                            <div id="content_factura" class="d-none">
                                ...
                                <div style="display: flex; justify-content: center;">
                                    ...
                                    <a class="btn btn-primary btn_imprimir_factura" style="margin-right: 10px;"
                                        target="_blank" href="{{ route('pdf_factura_compra') }}?token=0">Descargar e
                                        Imprimir</a>
