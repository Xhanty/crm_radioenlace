...
<head>
    ...
    <title>Comprobante de Egreso No. {{ $data->numero }}</title>
</head>
                ...
                <div class="tm_invoice_in">
                    ...
                    <div class="tm_invoice_info tm_mb22 tm_align_center">
                        <div class="tm_invoice_info_left tm_mb20_md" style="margin-top: 2px">
                            <p class="tm_mb0">
                                <b class="tm_primary_color ">Comprobante Egreso No: </b>{{ $data->numero }}<br>
                                <b class="tm_primary_color">Comprobante Siigo No:
