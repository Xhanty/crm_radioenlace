                    ...
                    <div class="card card-invoice">
                        <div class="card-header ps-3 pe-3 pt-3 pb-0 d-flex-header-table">
                            <div class="div-1-tables-header">
                                <h3 class="card-title">FACTURAS DE COMPRA <badge
                            ...
                            <div class="div-2-tables-header" style="margin-bottom: 13px">
                                ...
                                <button class="btn btn-primary" disabled style="margin-right: 10px; display: none" id="btnSiigo">:)</button>
                                <a href="{{ route('excel_factura_compra') }}" style="margin-right: 10px; display: none">
                                ...
                                <a href="{{ route('pdf_factura_compra_export') }}" target="_blank" style="margin-right: 10px; display: none">
                                ...
                                @foreach ($facturas as $key => $factura)
                                    ...
                                    <div class="media factura_btn {{ $bg }}" data-id="{{ $factura->id }}">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <h6><span>{{ $tipo }}{{ $factura->numero }}@if($bg == 'bg-pending')<badge
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    ...
                    <br>
                    <div class="text-center">
                        <a href="{{ route('factura_compra') }}" id="btn_clear">Limpiar filtros</a>
                    </div>
                </div>
            </div>
        </div>
