            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> Estadística Compra</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header d-flex-header-table bg-success" style="border-radius: 4px">
                        <div class="div-1-tables-header">
                            <h3 class="card-title mt-2">Estadisticas Compras</h3>
                            <div class="row row-sm">
                                <div class="col-lg">
...
@section('scripts')
    <script src="{{ asset('assets/js/app/contabilidad/estadistica_compra.js') }}"></script>
@endsection
