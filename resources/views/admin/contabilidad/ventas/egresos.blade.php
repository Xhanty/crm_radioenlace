    ...
    <div class="main-container container-fluid">
                                ...
                                <div id="content_factura" class="d-none">
                                    <div class="row mg-t-20">
                                        ...
                                        <div class="col-md">
                                            ...
                                            <p class="invoice-info-row"><span>Dónde ingresó</span> <span
                                    ...
                                    <div style="display: flex; justify-content: center;">
                                        ...
                                        <div class="dropdown">
                                            <button type="button" class="btn btn-primary dropdown-toggle btn_options_factura"
        ...
        <div class="modal  fade" id="modalCliente">
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    <div class="modal-header">
                        <h6 class="modal-title">Selecciona un cliente</h6>
                        <button aria-label="Close" class="btn-close" data-bs-dismiss="modal" type="button"><span
                                aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
