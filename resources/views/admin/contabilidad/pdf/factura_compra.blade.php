                                ...
                                <div class="tm_text_center">
                                    <p class="tm_accent_color tm_mb0">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 512 512" fill="currentColor" style="color: rgb(217, 38, 28, 0.9)">
                                            <path
                    ...
                    <div class="tm_table tm_style1">
                        <div class="tm_border tm_accent_border_20">
                            <div class="tm_table_responsive">
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="tm_width_6 tm_accent_border_20 tm_text_center">1. Servicios
                                                públicos - Teléfono
                                            </td>
                                            <td class="tm_width_1 tm_accent_border_20 tm_text_center">1</td>
                                            <td class="tm_width_2 tm_accent_border_20 tm_text_center">500,498.00</td>
                                            <td class="tm_width_2 tm_accent_border_20 tm_text_center">0%</td>
                                            <td class="tm_width_2 tm_accent_border_20 tm_text_center">0%</td>
                                            <td class="tm_width_2 tm_accent_border_20 tm_text_right">500,498.00</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="tm_invoice_footer tm_mb15 tm_m0_md">
                            <div class="tm_left_footer">
                                ...
                                <p class="tm_m0">Quinientos mil cuatrocientos noventa y ocho pesos m/cte</p>
                                <br>
