                ...
                <div class="card">
                    <div class="card-header d-flex-header-table bg-warning" style="border-radius: 4px">
                        <div class="div-1-tables-header">
                            <h3 class="card-title mt-2">Tarjetas Asignadas</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <i>No tienes tarjetas asignadas</i>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex-header-table bg-success" style="border-radius: 4px">
                        <div class="div-1-tables-header">
                            <h3 class="card-title mt-2">Tarjetas Culminadas</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <i>No tienes tarjetas culminadas</i>
                    </div>
                </div>
            </div>
        </div>
