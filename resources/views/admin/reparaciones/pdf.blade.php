                ...
                <td colspan="3">
                    <table>
                        <tr>
                            ...
                            <td>
                                <br>
                                <strong>Reparación:</strong> {{ $reparacion->token }}<br>
                                <strong>Fecha:</strong> {{ date('d-m-Y', strtotime($reparacion->created_at)) }}<br>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            @for ($i = 0; $i < count($repuestos); $i++)
                @if ($i == count($repuestos) - 1)
                    <tr>
                        ...
                        <td style="text-align: center; padding-top: 3%">{{ $repuestos[$i]->cantidad }}</td>
                    </tr>
                @else
                    <tr>
                        <td style="text-align: center; padding-top: 2%;">
