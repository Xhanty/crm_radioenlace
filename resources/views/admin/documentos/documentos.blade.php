            ...
            <div class="col-lg-4 col-xl-3">
                <div class="card">
                    <div class="main-content-left main-content-left-mail card-body">
                        <a class="btn btn-primary btn-compose" id="btnCompose" data-bs-target="#createfile"
                            data-bs-toggle="modal"><i class="fa fa-plus mx-2"></i> Crear Carpeta</a>
                        <div class="main-mail-menu">
                            <nav class="nav main-nav-column">
                                ...
                                <a class="nav-link thumb" href="javascript:void(0);"><i class="fe fe-folder"></i>
                                    Tesorería</a>
                                <a class="nav-link thumb" href="javascript:void(0);"><i class="fe fe-folder"></i> Recursos Humanos</a>
                                <a class="nav-link thumb" href="javascript:void(0);"><i class="fe fe-folder"></i> Coordinación Comercial </a>
                                <a class="nav-link thumb" href="javascript:void(0);"><i class="fe fe-folder"></i> Gerente Comercial</a>
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-auto file-1">
                        <div class="input-group mb-2">
                            <input type="text" class="form-control rounded-3  br-te-0 br-be-0"
                                placeholder="Search folder.....">
                            <span
                                class="input-group-text bg-transparent p-0 border-0 rounded-3 br-ts-0 br-bs-0   overflow-hidden">
                                <button class="btn ripple btn-danger br-ts-0 br-bs-0  " type="button">Search</button>
                            </span>
                        </div>
                    </div>
                </div>
                <div class="file-list tx-16">All Files</div>
                <div class="row mt-4">
                                ...
                                <div class="card-body">
                                    <div class="tx-16 mb-1">
                                        <svg class="file-manager-icon me-2" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 24 24">
                                            <path fill="#ffd79c"
                                                d="M20,9,13,2H7A3,3,0,0,0,4,5V19a3,3,0,0,0,3,3H17a3,3,0,0,0,3-3Z"></path>
                                            <path fill="#ffbd5a"
                                    ...
                                    <div class="tx-16 mb-1">
                                        <svg class="file-manager-icon me-2" xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <rect width="9" height="9" x="2" y="2"
                                                fill="#f74f75" rx="1"></rect>
                                            <rect width="9" height="9" x="2" y="13"
                                                fill="#fa95ac" rx="1"></rect>
                ...
                <div class="row">
                        ...
                        <div class="card p-0 ">
                            ...
                            <div class="card-body pt-0 text-center">
                                <div class="file-manger-icon">
                                    <a href="file-manager-list.html">
                                        <img src="../assets/img/files/folder.png" alt="img" class="rounded-7">
                                    </a>
                                </div>
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6">
                        <div class="card p-0 ">
                            ...
                            <div class="card-body pt-0 text-center">
                                <div class="file-manger-icon">
                                    <img src="../assets/img/files/image.png" alt="img" class="rounded-7">
                                </div>
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6">
                        <div class="card p-0 ">
                            ...
                            <div class="card-body pt-0 text-center">
                                <div class="file-manger-icon">
                                    <img src="../assets/img/files/file.png" alt="img" class="rounded-7">
                                </div>
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6">
                        <div class="card p-0 ">
                            ...
                            <div class="card-body pt-0 text-center">
                                <div class="file-manger-icon">
                                    <img src="../assets/img/files/word.png" alt="img" class="rounded-7">
                                </div>
