                ...
                <div class="card">
                    <div class="card-body iconfont text-start">
                        ...
                        <div class="d-flex mb-0">
                            <div class="">
                                <h4 class="mb-1 font-weight-bold" id="count_facturas">{{ count($facturas) }}</span>
                                </h4>
                            </div>
            ...
            <div class="col-md-12 col-lg-12 col-xl-6 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title pt-2">Clientes</h4>
                            <i class="mdi mdi-dots-Vertical"></i>
                        </div>
                ...
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="text-center">
                            <a href="{{ route('reporte_ventas') }}" id="btn_clear">Limpiar filtros</a>
                        </div>
                    </div>
                </div>
            </div>
...
@section('scripts')
    <script src="{{ asset('assets/js/app/reportes/ventas.js') }}"></script>
    <script>
